...
class 파일이름.extends 클라이언트한테_보여줄_위젯화면{
  ...
  데이터 내부가 null 이어도 되는 변수와 기능명을 구분지으며
  선언된 모든 변수와 기능은 생성자에서 필수인지 아닌지를 작성해야함
}
 */
class AddTodoDialog extends StatefulWidget {
  ...
  // _AddTodoDialogState 내부적으로 데이터를 주고받는 UI 가 변경되면
  // AdTodoDialog 선언한 변수나 기능을 _AddTodoDialogState 활용할 수 있다.
  @override
  State<AddTodoDialog> createState() => _AddTodoDialogState();
}

class _AddTodoDialogState extends State<AddTodoDialog>{
  // 외부 파일에 상태를 전달하기 위한 원격 리모콘 같은 컨트롤러 생성
